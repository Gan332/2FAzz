...
pub fn show(ui: &mut egui::Ui, app: &mut AuthenticatorApp) {
    ui.vertical(|ui| {
        ...
        egui::Frame::none()
            ...
            .inner_margin(16.0)
            .show(ui, |ui| {
                ui.label(egui::RichText::new("Length").size(13.0).color(app.theme.text_secondary()));
        ...
        egui::Frame::none()
            ...
            .inner_margin(16.0)
            .show(ui, |ui| {
                ui.label(egui::RichText::new("Character Sets").size(13.0).color(app.theme.text_secondary()));
                ui.add_space(4.0);
