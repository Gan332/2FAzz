...
pub fn dialog(ctx: &egui::Context, app: &mut AuthenticatorApp) {
    ...
    egui::Window::new("Add Token")
        ...
        .fixed_size(egui::vec2(360.0, 480.0))
        .resizable(false)
        .collapsible(false)
        .title_bar(false)
        ...
        .show(ctx, |ui| {
            ...
            ui.vertical_centered(|ui| {
                ui.label(egui::RichText::new("Add Token").size(18.0).color(theme.text_primary()));
            });
            ui.add_space(4.0);
            ...
            egui::Frame::none()
                ...
                .inner_margin(12.0)
                .show(ui, |ui| {
                    ui.label(egui::RichText::new("Type").size(13.0).color(theme.text_secondary()));
                    ui.horizontal(|ui| {
                        let types = [
                            ("TOTP", TokenType::Totp),
                        ...
                        for (label, tt) in types {
                            ...
                            let btn = egui::Button::new(
                                egui::RichText::new(label).size(13.0).color(if is_sel {
                                    egui::Color32::WHITE
                                } else {
                                    theme.text_primary()
                                }),
            ...
            egui::Frame::none()
                ...
                .inner_margin(12.0)
                .show(ui, |ui| {
                    ui.label(egui::RichText::new("Issuer").size(13.0).color(theme.text_secondary()));
                    ui.add_sized(
                        [ui.available_width(), 32.0],
                        egui::TextEdit::singleline(&mut app.new_token_issuer).hint_text("Google, GitHub..."),
                    );
                    ui.add_space(4.0);
                    ui.label(egui::RichText::new("Name").size(13.0).color(theme.text_secondary()));
                    ui.add_sized(
                        [ui.available_width(), 32.0],
                        egui::TextEdit::singleline(&mut app.new_token_name).hint_text("user@email.com"),
                    );
                    ui.add_space(4.0);
                    ui.label(egui::RichText::new("Secret").size(13.0).color(theme.text_secondary()));
                    ui.add_sized(
                        [ui.available_width(), 32.0],
            ...
            egui::Frame::none()
                ...
                .show(ui, |ui| {
                    ui.horizontal(|ui| {
                        ui.label(egui::RichText::new("Digits").size(13.0).color(theme.text_secondary()));
                        ui.add(egui::DragValue::new(&mut app.new_token_digits).range(4..=10));
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                            ui.label(egui::RichText::new("Period").size(13.0).color(theme.text_secondary()));
...
pub fn passkey_dialog(ctx: &egui::Context, app: &mut AuthenticatorApp) {
    ...
    egui::Window::new("Add Passkey")
        ...
        .show(ctx, |ui| {
            ui.add_space(8.0);
            ui.vertical_centered(|ui| {
                ui.label(egui::RichText::new("Add Passkey").size(18.0).color(theme.text_primary()));
            });
            ui.add_space(12.0);
            ...
            egui::Frame::none()
                ...
                .inner_margin(12.0)
                .show(ui, |ui| {
                    ui.label(egui::RichText::new("Relying Party ID").size(13.0).color(theme.text_secondary()));
                    ui.add_sized(
                        [ui.available_width(), 32.0],
                        egui::TextEdit::singleline(&mut app.new_passkey_rp).hint_text("example.com"),
                    );
                    ui.add_space(4.0);
                    ui.label(egui::RichText::new("Username").size(13.0).color(theme.text_secondary()));
                    ui.add_sized(
                        [ui.available_width(), 32.0],
                        egui::TextEdit::singleline(&mut app.new_passkey_username).hint_text("user@email.com"),
                    );
                    ui.add_space(4.0);
                    ui.label(egui::RichText::new("Display Name").size(13.0).color(theme.text_secondary()));
                    ui.add_sized(
                        [ui.available_width(), 32.0],
